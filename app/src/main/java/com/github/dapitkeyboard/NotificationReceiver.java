...
public class NotificationReceiver extends BroadcastReceiver {
    private CodingboardIME mIME;
    static public final String ACTION_SHOW = "com.github.dapitkeyboard.SHOW";
    static public final String ACTION_SETTINGS = "com.github.dapitkeyboard.SETTINGS";

    NotificationReceiver(CodingboardIME ime) {
        super();
        mIME = ime;
